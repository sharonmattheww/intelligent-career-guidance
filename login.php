...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT user_id, full_name, password_hash FROM Sers WHERE full_name = ?";
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        ...
                        echo "Fetched username: $username, Fetched hashed_password: $hashed_password<br>";
...
<head>
    ...
    <style>
        body{ font: 14px sans-serif; margin:auto; margin-top: 120px; width:500px; background-color: blueviolet; color: black; }
        .wrapper{ border-style: solid; border-color: blue; border-radius: 30px; padding: 20px; background-color: white; }
    </style>
</head>
<body>
    <!--Header-->
